package com.densoft.kafka.admin.clients;

import com.densoft.appconfigdata.config.KafkaConfigData;
import com.densoft.appconfigdata.config.RetryConfigData;
import com.densoft.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    private Collection<TopicListing> doGetTopics(RetryContext retryContext) throws ExecutionException, InterruptedException {
        ...
        if (topicListings != null) {
            topicListings.forEach(topicListing -> log.debug("Topic with name {}"));
        }
        return topicListings;
    }

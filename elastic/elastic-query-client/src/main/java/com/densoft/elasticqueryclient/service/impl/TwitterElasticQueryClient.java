...
import com.densoft.appconfigdata.config.ElasticQueryConfigData;
...
import com.densoft.elasticqueryclient.util.ElasticQueryUtil;
...
public class TwitterElasticQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    public TwitterIndexModel getIndexModelById(String id) {
        ...
        if (searchResult == null) {
            log.info("No document found at elastic with id {}", id);
